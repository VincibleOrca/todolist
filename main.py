...
def main(page: ft.Page):
    ...
    def view_tasks(task_id, task_text, completed=None):
        ...
        delete_button = ft.IconButton(icon=ft.Icons.DELETE,icon_color="red",on_click=delete_task)
    ...
    clear_button = ft.ElevatedButton("Очистить выполненные", icon=ft.Icons.DELETE_SWEEP, icon_color=ft.Colors.RED, on_click=clear_completed)
